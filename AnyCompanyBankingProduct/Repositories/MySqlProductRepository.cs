...
namespace AnyCompanyBankingProduct.Repositories
{
    ...
    public class MySqlProductRepository : IProductRepository
    {
        ...
        public MySqlProductRepository()
        {
            ...
            string connectionString = _configService.GetConnectionString("MySQLConnection");
            
            // Replace placeholders with environment variables if they exist
            string dbUser = _configService.GetEnvironmentVariable("DB_USER");
            string dbPassword = _configService.GetEnvironmentVariable("DB_PASSWORD");
            string dbServer = _configService.GetEnvironmentVariable("DB_SERVER");
        ...
        // Helper methods
        private Product CreateProductFromReader(MySqlDataReader reader)
        {
            return new Product
            {
        ...
        private void AddProductParameters(MySqlCommand command, Product product)
        {
